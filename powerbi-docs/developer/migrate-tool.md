...
Objekten i listan visas också en färg och ett nummer i formatet (N/N). Detta anger antalet rapporter som kan hämtas. Svart färg innebär att alla rapporter kan hämtas.
