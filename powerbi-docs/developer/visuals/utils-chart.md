...
Den här funktionen anger en anpassad domän men ändras inte när inget har angetts.
...
`Legend`-tjänsten innehåller hjälpgränssnitt för skapande och hantering av PBI-förklaringar för visuella Power BI-objekt
