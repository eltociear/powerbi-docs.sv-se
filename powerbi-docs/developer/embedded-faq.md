...
|Aktuell  |Power BI Embedded<br>(A SKU:er) |Power BI Premium-kapacitet<br>(A SKU:er)  |
|---------|---------|---------|
...
Power BI Embedded faktureras enligt en förutsägbar timavgift baserat på antalet distribuerade noder.
