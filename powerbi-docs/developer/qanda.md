...
Skapa en inbäddningstoken från en datauppsättning för att starta en frågor och svar-del. Mer information finns i [skapa token för frågor och svar](https://msdn.microsoft.com/library/mt784614.aspx#qanda).
