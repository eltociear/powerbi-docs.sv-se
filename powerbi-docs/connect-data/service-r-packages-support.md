...
ms.locfileid: "85235715"
---
# <a name="create-visuals-by-using-r-packages-in-the-power-bi-service"></a>Skapa visuella objekt med hjälp av R-paket i Power BI-tjänsten
...
De R-paket som stöds för **Power BI-tjänsten** hittar du i avsnittet med rubriken **Paket som stöds**. Om du vill begära support för ett R-paket som inte finns i listan kan du kontakta [Power BI Ideas](https://ideas.powerbi.com).
...
* Aktuell R-körmiljö: Microsoft R 3.4.4
...
|cirkumflex|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|Matris|1.2-12|https://cran.r-project.org/web/packages/Matrix/index.html|
...
|skräppost|2.1-3|https://cran.r-project.org/web/packages/spam/index.html|
