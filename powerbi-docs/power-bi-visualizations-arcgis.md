...
Vilka funktioner som är tillgängliga beror på om du är *skaparen* (personen som gjort kartan) eller *konsumenten* (någon har delat en ArcGIS-karta med dig). Om du interagerar med en ArcGIS-karta som konsument (det vill säga i [läsvyn](service-interact-with-a-report-in-reading-view.md)), kan du göra följande.
...
ArcGIS Maps för Power BI finns tillgängligt i följande tjänster och program:
...
**Finns det en avgift för att använda ArcGIS Maps för Power BI?**
