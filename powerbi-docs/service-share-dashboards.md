...
Du kan inte *dela* direkt från Power BI Desktop. Du [publicerar rapporter från Power BI Desktop](desktop-upload-desktop-files.md) till Power BI-tjänsten. Du kan dock [dela en instrumentpanel från Power BI-mobilappar](consumer/mobile/mobile-share-dashboard-from-the-mobile-apps.md).  
...
* Om dina medarbetare redan har åtkomst till en specifik instrumentpanel eller rapport kan du skicka en direktlänk genom att kopiera URL:en när du är på instrumentpanelen eller i rapporten. Till exempel: `https://powerbi.com/dashboards/g12466b5-a452-4e55-8634-xxxxxxxxxxxx`.
