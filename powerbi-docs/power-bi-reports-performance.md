...
För att ytterligare förbättra nätverksfördröjningen, överväg att använda [Azure ExpressRoute](https://azure.microsoft.com/en-us/services/expressroute/), vilket kan skapa snabbare och mer tillförlitliga nätverksanslutningar mellan klienter och Azure-datacenter. 
