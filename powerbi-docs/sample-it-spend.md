...
* [hämta innehållspaketet IT-utgiftsanalys](sample-tutorial-connect-to-the-samples.md)
* [hämta enbart datauppsättningen (Excel-arbetsboken) för det här exemplet](http://go.microsoft.com/fwlink/?LinkId=529783).
