...
I Power BI-tjänsten är rapportredigeraren endast tillgänglig i redigeringsvyn. Om du vill öppna en rapport i redigeringsvyn måste du vara rapportens ägare eller skapare, eller vara medverkande på apparbetsytan där rapporten finns.

Power BI-rapportredigeraren har tre avsnitt:  

1. Fönster för**fält**, **visualiseringar** och **filter**
2. övre navigeringsfälten    
3. rapportarbetsytan     

![Rapportredigerarens avsnitt](media/service-the-report-editor-take-a-tour/power-bi-report-canvas.png)
...
Tre fönster visas när du först öppnar en rapport: Visualiseringar, Filter och Fält. Fönstren till vänster, visualiseringar och filter, styr visualiseringarnas utseende, t.ex. typ, färger, filtrering, formatering.  Och fönstret till höger, fält, hanterar de underliggande data som används i visualiseringarna. 
...
### <a name="manage-the-fields-in-your-visual"></a>Hantera fälten i ditt visuella objekt
![mitten av visualiseringsfönstret](media/service-the-report-editor-take-a-tour/power-bi-field-list.png)

De bucketar (kallas ibland *källor*) som visas i det här fönstret varierar beroende på vilken typ av visualisering du har valt.  Om du till exempel har valt ett stapeldiagram visas bucketar för: Värden, Axel och Förklaring. När du markerar ett fält eller drar det till arbetsytan, så lägger Power BI till det fältet i någon av bucketarna.  Du kan också dra fält från fältlistan direkt till bucketarna.  Vissa bucketar är begränsade till vissa datatyper.  **Värden** accepterar t.ex. inte icke-numeriska fält. Om du drar ett **employeename**-fält till bucketen **Values** så ändrar Power BI den till **antal employeename**.
