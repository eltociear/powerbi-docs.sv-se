...
> [!NOTE]
> Fästa paneler för [live-rapportsida](service-dashboard-pin-live-tile-from-report.md) stöder ännu inte URL-filter. 
...
* Fästa paneler för *live-rapportsida* stöder ännu inte URL-filter. 
