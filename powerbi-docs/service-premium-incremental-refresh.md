...
För närvarande stöds bara inkrementell uppdatering för [sammansatta modeller](desktop-composite-models.md) för datakällor av typen SQL Server, Azure SQL Database, Oracle och Teradata.
