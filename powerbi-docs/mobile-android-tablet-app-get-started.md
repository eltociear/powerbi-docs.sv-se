---
title: "Kom igång med Power BI-mobilappen på Android-surfplattor"
description: "Lär dig hur Power BI-mobilappen för Android-surfplattor ger dig Power BI i din mobil med åtkomst till företagsinformation lokalt och i molnet."
services: powerbi
documentationcenter: 
author: maggiesMSFT
manager: kfile
...
---
# <a name="get-started-with-the-power-bi-mobile-app-on-android-tablets"></a>Kom igång med Power BI-mobilappen på Android-surfplattor
...
![Power BI-instrumentpanel på Android-surfplatta](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-report.png)
...
Sedan interagerar du i Power BI-appen för Android-surfplattor med dina instrumentpaneler och rapporter, antingen lokalt eller i molnet. Ta reda på [nyheterna i Power BI-mobilapparna](mobile-whats-new-in-the-mobile-apps.md).
...
* **Hämta appen** [Hämta Power BI för Android-appen](http://go.microsoft.com/fwlink/?LinkID=544867) från Google Play Butik.
  ...
  > [!NOTE]
  > Power BI kan köras på ett antal olika Android-surfplattor. Din surfplatta måste använda operativsystemet Android 5.0 eller senare. Om du vill kontrollera detta på din surfplatta, gå till **Inställningar** > **Om enheten** > **Android-version**. 
  > 
  > 
* **Börja när du öppnar appen**  Även utan att registrera dig eller logga in kan du, när du öppnar appen, bläddra igenom inloggningssidorna för en snabb överblick över vad du kan göra med Power BI-appen på din Android-surfplatta. Tryck på **Hoppa över** för att visa och utforska exemplen och praktisk information med appen. Du kan [gå tillbaka till exemplen](mobile-android-tablet-app-get-started.md#try-the-power-bi-and-reporting-services-samples) från instrumentpanelernas hemsida när du vill.
...
Om du inte har registrerat dig ännu, går du till [Power BI-tjänsten (http://powerbi.com/)](http://powerbi.com/) för att registrera dig för ditt eget konto för att skapa och lagra instrumentpaneler och rapporter och föra samman dina data. Logga sedan in på Power BI från din Android-surfplatta för att se dina egna instrumentpaneler varifrån du vill.
...
## <a name="get-started-with-the-power-bi-app-on-your-tablet"></a>Kom igång med Power BI-appen på surfplattan
1. Öppna Power BI för Android-appen från startskärmen på din Android-surfplatta.
   
   ![Startikon i Power BI](media/mobile-android-tablet-app-get-started/power-bi-logo-android.png)
2. Om du vill visa dina Power BI-instrumentpaneler och -rapporter trycker du på **Power BI**.  
   ...
   Om du vill visa din lokala Power BI-rapportserver och Reporting Services och KPI:er, trycker du på **Rapportserver**.
   
   ![Logga in i Power BI](media/mobile-android-tablet-app-get-started/power-bi-connect-to-login.png)
   
   Ge din rapportserver inloggningsinformation för att [visa rapporter och KPI:er på Power BI-rapportservern och Reporting Services](mobile-app-ssrs-kpis-mobile-on-premises-reports.md) i appen för Android-surfplatta för Power BI.
...
1. Tryck på den globala navigeringsknappen ![Den globala navigeringsknappen](media/mobile-android-tablet-app-get-started/power-bi-android-options-icon.png) i det övre vänstra hörnet.
2. Tryck på **Inställningar** > **Identifiera våra exempel**, välj en roll och utforska exempelinstrumentpanel för rollen. 
   
   ![Exempel på mobilapp för Power BI](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-samples.png)
...
2. Tryck på **Reporting Services-exemplen** och öppna antingen mappen för detaljhandelsrapporter eller försäljningsrapporter om du vill utforska deras KPI:er och mobila rapporter.
   ...
   ![Reporting Services-exempel](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-ssrs-samples.png)

## <a name="search-for-a-dashboard-or-report"></a>Sök efter en instrumentpanel eller rapport
* Tryck på förstoringsglaset i det övre högra hörnet ![Sökikonen](media/mobile-android-tablet-app-get-started/power-bi-ipad-search-icon.png), skriv sedan termen som du vill hitta.
  
    ![Sökresultat](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-search.png)
...
![Power BI, vänster navigeringsfönster](media/mobile-android-tablet-app-get-started/power-bi-mobile-new-nav-no-numbers.png)
...
* Tryck på **Favoriter**.
   ...
   ![Favoriter i det vänstra navigeringsfönstret](media/mobile-android-tablet-app-get-started/power-bi-android-favorites-left-nav.png)
   ...
   ![Sidan Favoriter](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-favorites.png)
...
Här följer några saker som du kan göra i Android-appen för surfplatta för Power BI med instrumentpaneler och rapporter i Power BI och rapporter och KPI:er i webbportalen för Power BI-rapportserver eller Reporting Services.
