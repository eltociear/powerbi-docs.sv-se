...
Med inkrementell uppdatering för Power BI-dataflöden krävs att arbetsytan där dataflödet finns har [Premiumkapacitet](../admin/service-premium-what-is.md) för att köras, och den datakälla som matas in i dataflödet måste ha ett fält med *datetime* på vilket inkrementell uppdatering kan filtrera. 
...
Du kan läsa mer om inkrementell uppdatering i [inkrementell uppdatering i Power BI Premium](../admin/service-premium-incremental-refresh.md).
