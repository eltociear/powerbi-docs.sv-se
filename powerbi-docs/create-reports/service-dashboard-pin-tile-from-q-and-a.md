...
1. Öppna en [instrumentpanel](../consumer/end-user-dashboards.md) som har minst en panel fäst från en rapport. När du skriver en fråga, letar Power BI efter svaret i alla datauppsättningar som har en panel fäst på den instrumentpanelen.  Läs mer i [hämta data](../connect-data/service-get-data.md).
