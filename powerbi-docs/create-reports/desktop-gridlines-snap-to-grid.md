...
![Skärmbild av rapportarbetsytan som visar hur du använder stödlinjer och fäst till rutnät i Power BI Desktop-rapporter.](media/desktop-gridlines-snap-to-grid/snap-to-grid_0.png)
...
![Skärmbild av rapportarbetsytan som visar hur du aktiverar stödlinjer och fäst till rutnät i Power BI Desktop-rapporter.](media/desktop-gridlines-snap-to-grid/snap-to-grid_1.png)
...
![Skärmbild av rapportarbetsytan som visar hur du använder stödlinjer till att justera dina kontroller.](media/desktop-gridlines-snap-to-grid/snap-to-grid_2.png)
...
![Skärmbild av en kontroll och avsnittet Stödlinjer på kortet Y-axel.](media/desktop-gridlines-snap-to-grid/snap-to-grid_9.png)
...
![Skärm bild av rapportarbetsytan som visar hur stödlinjer och fäst till rutnät kan se till att dina rapportkontroller är snyggt justerade.](media/desktop-gridlines-snap-to-grid/snap-to-grid_3.png)
...
![Skärmbild av rapportarbetsytan som visar hur du hanterar ordningen av kontroller framifrån och bak i en rapport.](media/desktop-gridlines-snap-to-grid/snap-to-grid_4.png)
...
![Skärmbild av rapportarbetsytan som visar hur du justerar dina kontroller på olika sätt.](media/desktop-gridlines-snap-to-grid/snap-to-grid_5.png)
...
![Skärmbild av rapportarbetsytan som visar hur du använder knappen Justera till att justera en vald kontroll till kanten (eller mitten) av arbetsytan.](media/desktop-gridlines-snap-to-grid/snap-to-grid_6.png)
...
![Skärmbild av rapportarbetsytan som visar hur du justerar två kontroller med alternativet Vänsterjustera.](media/desktop-gridlines-snap-to-grid/snap-to-grid_7.png)
...
![Skärmbild av rapportarbetsytan som visar hur du fördelar dina kontroller jämnt över arbetsytan med alternativet Distribuera.](media/desktop-gridlines-snap-to-grid/snap-to-grid_8.png)
