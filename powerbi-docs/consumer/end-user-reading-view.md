...
Om du vill visa att samma visualiseringen utan att störas av menyfält, filterfönstret och annan krom kan du välja ikonen **Helskärm** från den översta menyraden  ![helskärmsikon](media/end-user-reading-view/power-bi-focus-icon.png)  .
