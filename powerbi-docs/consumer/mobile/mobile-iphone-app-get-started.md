...
Tryck på **Favoriter** (![ikonen Favoriter](./media/mobile-iphone-app-get-started/power-bi-mobile-apps-home-favorites-icon.png)) i navigeringsfältet för att visa sidan med dina Favoriter. 
