...
ms.locfileid: "46565209"
---
# <a name="take-a-tour-of-the-report-filters-pane"></a>Ta en titt på panelen för rapportfilter
Den här artikeln tar en djup titt på filterrapportfönstret. Du ser fönstret i [Power BI-tjänsten Redigeringsvyn och Läsvyn](end-user-reading-view.md) och i [Power BI Desktop Rapportvyn](../desktop-report-view.md).
...
I Power BI Desktop öppnas rapporter i rapportvyn. I Power BI-tjänsten kan rapporter öppnas i [redigeringsvyn eller läsvyn](end-user-reading-view.md). I redigeringsvyn, och i rapportvyn i Desktop, kan rapportägare [lägga till filter för en rapport](../power-bi-report-add-filter.md) och dessa filter sparas med rapporten. Användare som visar rapporten i läsvyn kan interagera med filtren och spara sina ändringar, men de kan inte lägga till nya filter i rapporten.
...
## <a name="clear-a-filter"></a>Rensa ett filter
 Välj ikonen Radera ![](media/end-user-report-filter/pbi_erasericon.jpg) i antingen grundläggande eller avancerat filtreringsläge för att rensa filtret. 
...
[Interagera med filter och markeringar i rapportens läsvy](end-user-reading-view.md)  
[Skapa filter i rapportens redigeringsvy](../power-bi-report-add-filter.md)  
[Ändra hur en rapports visuella objekt korsfiltrerar och korsmarkerar varandra](end-user-interactions.md)
