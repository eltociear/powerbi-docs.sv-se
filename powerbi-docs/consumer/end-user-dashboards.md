...
De visualiseringar som visas på instrumentpanelen kallas *paneler* och de *fästs* på instrumentpanelen av rapportdesigner. Om du väljer en panel kommer du till den rapportsida där visualiseringen skapades. Om du är nybörjare på Power BI kan du få en god grund genom att läsa [Grundläggande begrepp i Power BI](end-user-basic-concepts.md).
...
| Prenumerera |Kan prenumerera på e-post från instrumentpaneler |Kan prenumerera på e-post från rapportsidor |
