...
* I e-postprenumerationer saknas stöd för de flesta [visuella Power BI-objekt](../developer/visuals/power-bi-custom-visuals.md).  Undantaget är de visuella Power BI-objekt som har [certifierats](../developer/visuals/power-bi-custom-visuals-certified.md).  
