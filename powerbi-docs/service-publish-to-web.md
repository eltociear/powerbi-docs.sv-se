...
> 
> [!IMPORTANT]
> Power BI-administratörer kan inaktivera möjligheten för användare att använda Publicera på webben från administratörsportalen. Ställ in **Publicera på webben** på **Av** i **Klientinställningar**. Det här är en klientomfattande inställning. Mer information finns i [Power BI-administratörsportalen](service-admin-portal.md).
> 
> 
