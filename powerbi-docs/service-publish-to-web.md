...
Power BI-administratörsportalen har inställningar som styr vem som kan publicera på webben. Du behöver kontakta organisationens [Power BI-administratör](service-admin-role.md) om du vill ändra [Klientinställningar för publicera på webben](service-admin-portal.md#publish-to-web) i administratörsportalen.
...
Du behöver [hitta någon av dessa personer](https://docs.microsoft.com/office365/admin/admin-overview/admin-overview#who-has-admin-permissions-in-my-business) i din organisation och be dem att uppdatera [Klientinställningar för publicera på webben](service-admin-portal.md#publish-to-web) i administratörsportalen.
