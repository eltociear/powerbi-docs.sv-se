...
- För att få åtkomst till en Power BI-datamängd behöver du ha behörigheten Skapa för datamängden. Läs om [behörigheten Skapa](service-datasets-build-permissions.md#build-permissions-for-shared-datasets).
